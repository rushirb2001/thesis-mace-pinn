...
def sample_collocation_points_2d(num_points, x_data, y_data):
    ...
    t_rand = sorted(random.uniform(key, (num_points,), minval=0, maxval=2))
...
def train_pinn_2d(
    ...
    for w_idx in range(num_windows):
        ...
        optim_u = create_optimizer(
            peak_lr=1e-4,        # Base LR from literature
...
if __name__=="__main__":
    ...
    save_trained_params(trained_params, "trained_params_sliding_optimisation_uv_value_100.pkl")