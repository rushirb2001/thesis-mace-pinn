...
if __name__ == "__main__":
    ...
    run = wandb.init(project="final_model_presentation", config=config)
    data = load_grey_scott_mat(f"grey_scott_variation{variation}.mat") if model_type == 0 else load_grey_scott_mat(f"ginzburg_landau_square_{variation}.mat")
    trained_state = train(config, data)
    ckpt_dir = f"/home/rbhavsa4/final_checkpoints/grey_scott/variation_{variation}" if model_type == 0 else f"/home/rbhavsa4/final_checkpoints/ginzburg_landau/square_{variation}"
