...
for i in tqdm(range(0,5)):
        variation = i
        run = wandb.init(project="gray-scott-pinn-thesis-finale-mlp", config=config, reinit=True)
        data = load_grey_scott_mat(f"grey_scott_variation{variation}.mat")
        trained_state = train(config, data)
        ckpt_dir = f"/home/rbhavsa4/final_checkpoints/grey_scott/mlp_variation_{variation}" 
